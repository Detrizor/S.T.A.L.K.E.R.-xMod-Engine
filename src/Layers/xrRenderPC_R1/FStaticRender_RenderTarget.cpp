...
{
	return Available() && 
		( ((BOOL)RImplementation.m_bMakeAsyncSS) || NeedPostProcess() || (ps_r__Supersample>1) || (frame_distort==(::Render->dwFrame()-1)));
}
