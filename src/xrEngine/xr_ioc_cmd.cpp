...
void CCC_Register()
{
	...
	// Texture manager
	CMD4(CCC_Integer, "texture_lod", &psTextureLOD, 0, 1);
	...
	psVertSensScale = 1.f;
	psMouseDPI = 400.f;
	psMouseSensScale = 0.0399f;
	CMD4(CCC_Float, "mouse_sens", &psMouseSens, 1.f, 200.f);
	CMD4(CCC_Float, "aim_sens_scale", &psAimSensScale, 0.f, 2.f);
	CMD4(CCC_Float, "ads_sens_scale", &psADSSensScale, 0.f, 2.f);
	CMD4(CCC_Float, "vert_sens_scale", &psVertSensScale, 0.f, 2.f);
	CMD4(CCC_Float, "mouse_dpi", &psMouseDPI, 100.f, 50000.f);
	CMD4(CCC_Float, "mouse_sens_scale", &psMouseSensScale, 0.f, 1.f);
	...
	{
	public:
		CCC_Stats(LPCSTR N, Flags32* V, u32 M) : CCC_Mask(N, V, M) {};
	...
	CMD3(CCC_Stats, "rs_stats", &psDeviceFlags, rsStatistic);
};
